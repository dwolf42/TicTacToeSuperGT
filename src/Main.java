...
public class Main {
    ...
    public static void printArrayBoardArt(char[][] board) {
        ...
        String[] rightOfBoardCastleArt = {
                /*25 2/2*/ BB + "| " + WB + "  |  |  |     |          /' _,  /._/|__K" + RE,
                /*26 2/2*/ BB + "| " + WB + "  |  |  |    -|          `~~ -,   // '~~~\\;;," + RE,
                /*27 2/2*/ BB + "| " + WB + "  |  |  |  _  |             ,_( _||_..\\ L| ';;" + RE
        };

        String[] lowerCastleArt = {
                /*28*/ G + "    '--~~__ " + WB +"|   |    " + BB + "--------- " + WB + "  |  | " + G + "_" + WB + "|" + G + "_    " + WB + "|            / ~|/ ~' `\\<\\>´  ;;" + RE,
                /*29*/ G + "           ~---___________________---~   ~`---,          " + WB + "/   |      /  |   ;" + RE,
                /*30*/ G + "                                               ~~----____" + WB + "\"" + G + "~--" + WB + "|" + G + "~~----" + WB + "/" + G + "__" + WB + "|" + G + "____---____-~---~~--" + RE,
                /*31*/ G + "                  ~----__                                    " + WB + "\"      \"  \"" + RE,
                /*32*/ G + "                        `~~----____-~---~~----____-~" + RE
        };
...
Credits:
Horse and knight, inspired by Tua Xiong and Andreas Freise, on asciiart.eu
