...
public class Main {
    ...
    static String[] upperCastleArtBasic = {
  ...
  static String[] upperCastleArtFireworks2 = {
   ...
   static String[] leftOfBoardCastleArt = {
            /*25 1/2*/ "   |     |  |   |  >1| ",
            /*26 1/2*/ "   |-    |  |   |  >2| ",
            /*27 1/2*/ "   _ _   |  |   |  >3| "
    };

   static String[] rightOfBoardCastleArt = {
            /*25 2/2*/ "|   |  |  |     |          /' _,  /._/|__K",
            /*26 2/2*/ "|   |  |  |    -|          `~~ -,   // '~~~\\;;,",
            /*27 2/2*/ "|   |  |  |  _  |             ,_( _||_..\\ L| ';;"
    };

    static String[] lowerCastleArt = {
            /*28*/ "    '--~~__ |   |    ---------   |  | _|_    |            / ~|/ ~' `\\<\\>   ;;",
...
Credits:
Horse and knight, inspired by Tua Xiong, Andreas Freise, and Joan Stark on asciiart.eu
